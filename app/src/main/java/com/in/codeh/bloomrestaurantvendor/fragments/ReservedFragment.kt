...
class ReservedFragment : Fragment() {
    ...
    private var status: String = "Confirm"
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_reserved,container,false)

        val activity = activity as Context
        recyclerView = view.findViewById(R.id.reserved_recyclerview)
